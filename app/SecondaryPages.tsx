...
export function TechnologyPage() {
  ...
  return <main><SiteNav />
    ...
    <section className="notice-panel"><div><p className="eyebrow">CURRENT WEB DEMO</p><h2>The browser demonstration uses an earlier implementation.</h2></div><p>Our newer PulseWindow research engine adds denser facial tracking, skin filtering, motion rejection and signal-quality weighting. It is currently being prepared for browser and iPhone integration.</p><a className="button secondary" href="/demo">Open the demo</a></section>
    <SiteFooter />
  </main>;
}
...
export function DemoPage() {
  return <main><SiteNav />
    <PageHero eyebrow="CAMERA PROTOTYPE" title="Try a guided camera check.">This demonstration shows the current patient experience using our earlier browser-compatible measurement method.</PageHero>
    <section className="demo-page section-shell"><div className="demo-main"><div className="demo-version"><span>Browser prototype</span><p>The newer PulseWindow multi-region research engine is being prepared for web integration.</p></div><CameraDemo /></div><aside className="demo-aside"><div><span>01</span><h3>Find even lighting</h3><p>Face a steady light source and avoid strong light behind you.</p></div><div><span>02</span><h3>Position your face</h3><p>Keep your face, shoulders and upper chest visible in the frame.</p></div><div><span>03</span><h3>Remain still</h3><p>Movement changes the camera signal and can interrupt the measurement.</p></div><div className="privacy-box"><strong>Local camera processing</strong><p>The demo processes camera frames in your browser. It does not upload or store your facial video.</p></div></aside></section>
    <SiteFooter />
  </main>;
}
